        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Back-Office')" class="grid">
                    <flux:navlist.item icon="layout-grid" :href="route('admin.user.index')" :current="request()->routeIs('admin.users.*')" wire:navigate>Users</flux:navlist.item>
                    <flux:navlist.item icon="layout-grid" :href="route('admin.inventory.index')" :current="request()->routeIs('admin.inventory.*')" wire:navigate>Inventory</flux:navlist.item>
                    <flux:navlist.item icon="folder-git-2" :href="route('admin.products.index')" :current="request()->routeIs('admin.products.*')" wire:navigate>Products</flux:navlist.item>
