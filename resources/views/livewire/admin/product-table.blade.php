                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="h-12 w-12 flex-shrink-0 rounded-lg overflow-hidden border border-gray-200 bg-gray-50 shadow-sm group">
                                            ...
                                            @else
                                                ...
                                                <img src="https://images.unsplash.com/photo-1560393464-5c69a73c5770?q=80&w=100&auto=format&fit=crop"
                                                    class="h-full w-full object-cover opacity-60 grayscale group-hover:grayscale-0 transition-all duration-300">
                                            @endif
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-xs font-mono text-gray-400">{{ $product->slug }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
                                    ...
                                    <button wire:click="delete({{ $product->id }})" class="text-red-600 hover:text-red-900"
                                        onclick="confirm('Delete this product?') || event.stopImmediatePropagation()">Delete</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    @if($isOpen)
        <div class="fixed inset-0 overflow-y-auto z-50">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    class="relative inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white rounded-lg shadow-xl">
                    ...
                    <form wire:submit.prevent="store">
                        ...
                        <div class="px-6 py-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.defer="slug" readonly
                                    class="mt-1 block w-full border-gray-300 rounded-md bg-gray-50 sm:text-sm text-gray-500 cursor-not-allowed">
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2 flex items-center space-x-4">
                                    @if ($new_image)
                                        <img src="{{ $new_image->temporaryUrl() }}" class="h-16 w-16 object-cover rounded-md">
                                    @elseif ($image_url)
                                        <img src="{{ asset('storage/' . $image_url) }}"
                                ...
                                <div wire:loading wire:target="new_image" class="text-xs text-indigo-600 mt-2">Uploading
                                    preview...</div>
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="is_active_check" class="ml-2 block text-sm text-gray-900 font-medium">Set as
                                    Active</label>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-4 bg-gray-50 flex justify-end space-x-3">
                            <button type="button" wire:click="$set('isOpen', false)"
                                class="px-4 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">Cancel</button>
                            <button type="submit"
                                class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
                                {{ $selected_id ? 'Update' : 'Create' }} Product
                            </button>
                        </div>
                    </form>
                </div>
