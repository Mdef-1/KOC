<nav class="flex items-center justify-between px-6 py-4 bg-white border-b">
    ...
    <div class="hidden md:flex items-center gap-6">
        @auth
            <a href="{{ route(name: 'dashboard') }}" class="text-sm font-medium text-gray-600 hover:text-pink-500">
                Dashboard
            </a>
        @endauth
    </div>
    ...
    {{-- Mobile Menu Button --}}
    <div class="md:hidden">
        <button type="button" class="text-gray-500 hover:text-gray-600" x-data="{ open: false }" @click="open = !open">
    ...
    {{-- Mobile Menu --}}
    <div class="md:hidden absolute top-16 left-0 right-0 bg-white shadow-lg py-2 z-50" x-show="open" @click.away="open = false" x-transition>
